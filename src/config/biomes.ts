...
export const BIOME_DEFINITIONS: BiomeDefinition[] = [
  {
    ...
    resources: [
      { itemId: 'wood', density: 0.12 }, { itemId: 'stone', density: 0.04 },
      { itemId: 'berries', density: 0.05 }, { itemId: 'herbs', density: 0.04 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'iron_ore', density: 0.10 }, { itemId: 'copper_ore', density: 0.06 },
      { itemId: 'coal', density: 0.04 }, { itemId: 'crystal', density: 0.02 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'rare_mushroom', density: 0.08 }, { itemId: 'swamp_reed', density: 0.06 },
      { itemId: 'slime_gel', density: 0.04 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'obsidian', density: 0.08 }, { itemId: 'fire_crystal', density: 0.04 },
      { itemId: 'rare_ore', density: 0.02 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'shadow_essence', density: 0.08 }, { itemId: 'void_crystal', density: 0.04 },
      { itemId: 'corrupted_wood', density: 0.06 },
    ],
