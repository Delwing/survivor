...
export const BIOME_DEFINITIONS: BiomeDefinition[] = [
  {
    ...
    resources: [
      { itemId: 'wood', density: 0.3 }, { itemId: 'stone', density: 0.1 },
      { itemId: 'berries', density: 0.15 }, { itemId: 'herbs', density: 0.1 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'iron_ore', density: 0.25 }, { itemId: 'copper_ore', density: 0.15 },
      { itemId: 'coal', density: 0.1 }, { itemId: 'crystal', density: 0.05 },
    ],
  ...
  },
  {
    ...
    resources: [
      { itemId: 'rare_mushroom', density: 0.2 }, { itemId: 'swamp_reed', density: 0.15 },
  ...
  },
  {
    ...
    resources: [
      { itemId: 'obsidian', density: 0.2 }, { itemId: 'fire_crystal', density: 0.1 },
  ...
  },
  {
    ...
    resources: [
      { itemId: 'shadow_essence', density: 0.2 }, { itemId: 'void_crystal', density: 0.1 },
